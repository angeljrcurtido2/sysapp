...
import { View, Text, ScrollView, Pressable, TextInput, Alert, ActivityIndicator, TouchableOpacity } from 'react-native';
...
export default function ListarProveedores({ onSelect, onClose }: ListarProveedoresProps) {
                    ...
                    <View className="flex-row items-center justify-between mb-4">
                        ...
                        {onClose && (
                            <TouchableOpacity
                                onPress={onClose}
                                activeOpacity={0.7}
                                className=" h-9 w-9 rounded-md items-center justify-center bg-gray-100 z-20"
