      ...
      >
        ...
        >
          ...
          <View className="flex-row gap-3">
            ...
            <View className="bg-white/20 rounded-xl p-3 flex-row items-center gap-2 flex-1">
              <TextInput
                className="bg-white rounded-lg px-2 py-1 text-center text-gray-800 w-10 text-sm"
              ...
              />
              <Text className="text-white text-xs flex-shrink" numberOfLines={1}>/ pág</Text>
            </View>
          </View>
        </LinearGradient>
                ...
                >
                  ...
                  <View className="flex-row gap-2 mt-3 pt-3 border-t border-gray-100">
                    {onSelect ? (
                      ...
                      >
                        <View className="bg-blue-500 rounded-xl py-2.5 flex-row items-center justify-center gap-1.5">
                      ...
                      <>
                        <Pressable
                          ...
                          className="flex-1 active:opacity-70"
                        >
                          <View className="bg-red-500 rounded-xl py-2.5 flex-row items-center justify-center gap-1.5">
