...
const FormCheque: FC<Props> = ({ onClose, datosCheque, setDatosCheque }) => {
    ...
    const dateFields = [
        { label: 'Fecha Emisión', name: 'fecha_emision', placeholder: 'Seleccionar fecha de emisión' },
        { label: 'Fecha Vencimiento', name: 'fecha_vencimiento', placeholder: 'Seleccionar fecha de vencimiento' },
    ];
        ...
        >
            ...
            >
                ...
                <View className="gap-5">
                    ...
                    {dateFields.map(({ label, name, placeholder }) => (
                        <DatePickerInput
                            key={name}
                            label={label}
                            value={datosCheque[name] || ''}
