...
export default function DatePickerInput({
  ...
  // Parsear fecha inicial evitando problemas de zona horaria
  ...
  // Actualizar estados cuando cambie el valor desde afuera
  useEffect(() => {
    if (value) {
      const [year, month, day] = value.split('-').map(Number);
  ...
  const handleConfirm = () => {
    // Crear fecha directamente en formato YYYY-MM-DD sin conversión de zona horaria
  ...
  const formatDisplayDate = (dateString: string) => {
    ...
    // Parsear fecha directamente desde YYYY-MM-DD evitando problemas de zona horaria
